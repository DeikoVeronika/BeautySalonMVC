...
namespace BeautySalonInfrastructure.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ClientsController(DbbeautySalonContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FirstName,LastName,Phone,Birthday,Email,Id")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
